...
class Homepage : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val recyclerRecommendResort = view.findViewById<RecyclerView>(R.id.recyclerResortsRecommend)
        val recyclerBestResort = view.findViewById<RecyclerView>(R.id.recyclerResortsBest)
